...
class VectorIndexType(Enum):
    VI_HNSW = search_pb2.VI_HNSW


class HNSWIndexParameter(object):

    def __init__(self, m, ef_construction):
        self.m = m
...
class VectorOptions(object):
    ...
    def __init__(self, data_type, metric_type, index_type, index_parameter, dimension):
