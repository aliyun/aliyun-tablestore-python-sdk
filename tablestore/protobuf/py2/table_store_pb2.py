...
_SQLPAYLOADVERSION = descriptor.EnumDescriptor(
...
_SQLSTATEMENTTYPE = descriptor.EnumDescriptor(
...
_SQLQUERYREQUEST = descriptor.Descriptor(
...
_TABLECONSUMEDCAPACITY = descriptor.Descriptor(
...
_SEARCHCONSUMEDCAPACITY = descriptor.Descriptor(
...
_SQLQUERYRESPONSE = descriptor.Descriptor(
...
class SQLQueryResponse(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
