...
_sym_db.RegisterEnumDescriptor(_COMPARATORTYPE)
...
DESCRIPTOR.enum_types_by_name['ComparatorType'] = _COMPARATORTYPE
...
SingleColumnValueFilter = _reflection.GeneratedProtocolMessageType('SingleColumnValueFilter', (_message.Message,), dict(
  ...
  __module__ = 'table_store_filter_pb2'
...
CompositeColumnValueFilter = _reflection.GeneratedProtocolMessageType('CompositeColumnValueFilter', (_message.Message,), dict(
...
_sym_db.RegisterMessage(CompositeColumnValueFilter)
